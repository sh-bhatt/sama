      ...
      <div className="mt-4 space-y-3">
        {activities.length ? (
          activities.map((activity) => (
            <div key={activity.id} className="rounded-2xl bg-black/35 px-4 py-3">
              <p className="text-sm font-black text-white">{activity.message}</p>
          ...
          <p className="theme-muted rounded-2xl bg-black/35 px-4 py-3 text-sm font-bold">
