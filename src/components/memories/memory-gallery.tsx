...
export function MemoryGallery({
  ...
  if (!memories.length) {
    return (
      <section className="film-grain relative overflow-hidden rounded-[2rem] border border-zinc-950/10 bg-white/58 p-8 text-center">
  ...
  return (
    <section className="relative overflow-hidden rounded-[2rem] border border-zinc-950/10 bg-white/58 p-3 sm:p-4">
